...
Pane
{
    ...
    Connections
    {
        ...
        function onCurr_filterChanged()
        {
            ...
            {
            case 1:
                content_stack.replace(null, "WrapperMainView.qml", {});
                break;
            case 2:
                content_stack.replace(null, "WrapperRXView.qml", {});
                break;
            case 3:
                content_stack.replace(null, "WrapperTXView.qml", {});
                break;
            case 4:
                content_stack.replace(null, "WrapperRXTXQueuesView.qml", {});
                break;
            case 5:
                content_stack.replace(null, "WrapperSettings.qml", {});
                break;
